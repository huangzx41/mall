...
public class Property {
	...
	public String toString() {
		return "Property{" + "property_id=" + property_id + ", property_name='" + property_name + '\''
				+ ", property_category=" + property_category + ", propertyValueList=" + propertyValueList + '}';
	}

	public Property(Integer property_id, String property_name, Category property_category,
